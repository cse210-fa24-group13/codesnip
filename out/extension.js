...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("extension.openPage" /* commands.CommandsConsts.commonOpenPage */, () => __awaiter(this, void 0, void 0, function* () { return handleCommand(() => openPage(context)); })));
    let panel;
    function openPage(context) {
        console.log("creating window");
        panel = vscode.window.createWebviewPanel('webviewFirstPage', // Identifies the webview panel (type)
        'Snippets Page', // Title
